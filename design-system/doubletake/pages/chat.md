...
1. **Header**: back, title in the prose face (24 px), platform glyph, overflow menu (Tags…,
   Collections…, Research again deeper; Export and Delete are planned and will sit behind a
...
4. **Tabs** under the answer (Base UI Tabs): **Claims** (verdict chip ✓ / ~ / ✗ in
   `--ok/--warn/--err`, confidence bar, sources), **Things** (entity cards grouped by kind),
