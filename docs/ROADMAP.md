...
~~Telegram and ntfy notification channels~~ (done 2026-09-04, [ADR 0019](adr/0019-owner-notification-channels.md)) · ~~iOS share extension~~ (done 2026-09-04, simulator-verified, [ADR 0027](adr/0027-ios-share-extension.md); **unverified** on a device) · ~~tailscale multi-device
